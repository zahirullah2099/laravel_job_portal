                             ...
                             <div class="table-responsive">
                                 <table class="table ">
                                     ...
                                     <tbody class="border-0">
                                             ...
                                             @foreach ($savedJobs as $savedJob)
                                                 <tr class="active">
                                                     ...
                                                     <td>
                                                         ...
                                                         <div class="info1">{{ $savedJob->job->user->email }}</div>

                                                     </td>
                                                     <td>

                                                         @if (Carbon::parse($savedJob->job->expiry_date)->isPast())
                                                                <span class="badge bg-danger text-white">Expired</span>
                                                            @else
                                                              {{ date_formated($savedJob->job->expiry_date) }}
                                                         @endif
                                                     </td>
                                                     <td>
                                                             ...
                                                             <ul class="dropdown-menu dropdown-menu-end">
                                                                 ...
                                                                 <li>
                                                                     <a class="dropdown-item" href="#"
                                                                         onclick="event.preventDefault(); removeJob({{ $savedJob->id }})">
                                         ...
                                         @else
                                             <tr>
                                                 <td class="text-danger text-center"><b>You haven't saved any job yet!</b>
                                                 </td>
                                             </tr>
                                         @endif
                                     </tbody>
