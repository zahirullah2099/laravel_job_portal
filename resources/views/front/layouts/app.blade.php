        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a class="btn btn-primary mx-2" href="{{ route('account.createJob') }}" type="submit">Post a
                        Job</a>
                    {{-- ----------------------- --}}
                    @if (Auth::check())
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="profilePicForm" method="post" name="profilePicForm" enctype="multipart/form-data"
                        action="">
                        <div class="mb-3">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == false) {
                        ...
                        // you can use this code to reload the page (both) 
